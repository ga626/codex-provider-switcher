...
assert(packageJson.scripts['tauri:dev'].includes('--bin codex-provider-switcher'), 'tauri:dev must select the desktop binary explicitly')
assert(packageJson.scripts['tauri:build'].includes('--bin codex-provider-switcher'), 'tauri:build must select the desktop binary explicitly')
