...
try {
    ...
    $required = @(
        ...
        "docs\README.md",
        "docs\contributing\development-and-prs.zh.md",
        "docs\maintainers\release-and-delivery.zh.md",
        "docs\maintainers\dependency-security.zh.md",
        "docs\reference\product-spec.zh.md",
        "docs\reference\repository-structure.zh.md",
        ...
        "scripts\release\release-channel-smoke.mjs",
        ...
        "scripts\qa\start-dev-desktop.ps1",
        "scripts\qa\refresh-local-candidate.ps1",
        "scripts\qa\prepare-local-install-migration.ps1",
        "scripts\qa\tauri-candidate-build.json",
